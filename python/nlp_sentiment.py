...
# pull data out of the html response and strip all html tags
    ...
    tweet_tokens = tokened.tokenize(text)
    ...
    positive_dataset = [(tweet_dict, "Postiive")
    ...
    print(tweet_tokens, classifier.classify(dict([token, True] for token in tweet_tokens)))